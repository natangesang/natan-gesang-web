...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:info@natangesang.edu.ar?subject=${subject}&body=${body}`;
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Se ha abierto tu cliente de email con el mensaje preparado.",
        duration: 5000,
      });
      setFormData({
        name: '',
      ...
      <div ref={sectionRef} className="container-section opacity-0 translate-y-10 transition-all duration-700">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <div className="pt-6">
              <a
                href="https://wa.me/5491141472720"
                target="_blank"
            ...
            <div className="pt-6 bg-gradient-to-r from-natan-blue to-natan-purple rounded-2xl overflow-hidden shadow-natan">
              <div className="p-8">
                <div className="text-center text-white">
                  <h3 className="text-2xl font-bold mb-4">Síguenos en redes sociales</h3>
                  <p className="text-blue-100 mb-8">Mantente conectado con nuestra comunidad educativa</p>
                  ...
                  <div className="flex flex-wrap gap-4 justify-center">
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="bg-blue-600 hover:opacity-90 transition-opacity p-4 rounded-full text-white flex items-center justify-center shadow-lg"
                      aria-label="LinkedIn"
                    >
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 hover:opacity-90 transition-opacity p-4 rounded-full text-white flex items-center justify-center shadow-lg"
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="bg-blue-700 hover:opacity-90 transition-opacity p-4 rounded-full text-white flex items-center justify-center shadow-lg"
                      aria-label="Facebook"
                    >
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer" 
                      className="bg-red-600 hover:opacity-90 transition-opacity p-4 rounded-full text-white flex items-center justify-center shadow-lg"
                      aria-label="YouTube"
                    >
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
