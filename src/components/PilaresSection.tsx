...
const PilaresSection = () => {
  ...
  useEffect(() => {
    const preloadImages = [
      "/lovable-uploads/007342b7-cf3e-46d5-b9c0-4a8a1f77c61e.png",
      "/lovable-uploads/8a8efef4-86c4-4085-b1c3-7cbf963d52db.png",
      "/lovable-uploads/8ba07f59-0382-461c-9776-3210328f3f51.png"
    ];
  ...
  return (
    <section 
      ...
      style={{
        backgroundImage: `url('/lovable-uploads/5c05a20e-d14c-46ca-be48-2394bf5156a5.png')`,
    ...
    >
      ...
      <div className="absolute inset-0 bg-natan-blue/80 z-0"></div>
